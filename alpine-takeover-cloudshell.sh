...
echo "THIS WILL BREAK YOUR CLOUD SHELL (EDITOR, OPENING ANOTHER TAB) PLEASE RUN THIS IN SAFE MODE AND DISABLE TMUX, IF YOU WISH NOT TO USE THIS SCRIPT PRESS CTRL+C"
sleep 15
